...
option_t ioopm_linked_list_insert(ioopm_list_t *list, int index, elem_t value);
...
void ioopm_linked_list_apply_to_all(ioopm_list_t *list, ioopm_apply_function_list fun, void *extra);


void ioopm_filter_all(ioopm_list_t *list, ioopm_predicate_list pred, void *extra);


void ioopm_inform_removal(elem_t *value, void *arg);

option_t ioopm_remove_node(ioopm_list_t *iterator_list, node_t *remove_node);
